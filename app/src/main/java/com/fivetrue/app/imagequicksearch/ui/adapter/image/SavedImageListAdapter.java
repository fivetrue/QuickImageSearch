...
public class SavedImageListAdapter extends BaseFooterAdapter<StoredImage> {

    private static final String TAG = "ImageListAdapter";


    public SavedImageListAdapter(List<StoredImage> data, OnItemClickListener<StoredImage> ll){
        super(data);
    ...
    protected void onBindHolder(RecyclerView.ViewHolder holder, int position) {
        StoredImage item = getItem(position);
